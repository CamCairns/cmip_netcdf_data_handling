...
def fetch_nc_data(time_length,category,experi, freq, realm, vari, model_list, ensemble=None, mount_dir='mountpoint'):
    ...
    files = nc.get_filepath(category,experi, freq, realm, vari, model_list[0], ensemble=None, mount_dir=mount_dir)
    ...
    for i1, model in enumerate(model_list):
        ...
        if files:
            ...
            R = nc.round_time(files, model_size)
