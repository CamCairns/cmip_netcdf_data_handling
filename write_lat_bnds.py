...
def write_lat_bnds():
'''
Creates a variable lat_bnds and populates it with data from the corresponding AMIP experiment. Called from write_lonb_latb.py. 
...
#                         # Set Variables
                        latitude_bnds = nc.createVariable('lat_bnds','f8',('lat','bnds'))
                        nc.close
                        write_field_value(files_SPOOKIE[0],'lat_bnds',input_latb)
                    else: 
