...
freq_list = ['mon']
experi_list = ['convoffamip']#,'convoffaqua4K','convoffaquaControl'] #['amip4K', 'amip4xCO2', 'aqua4xCO2', 'aqua4K', 'aquaControl'] #[,'convoffamip4xCO2']
exp_dir = 'SPOOKIE'
realm_list = ['atmos']
vari_list = ['zg'] #,'uas','va','vas','ta','tas','hur','hus']
            ...
            for i4, vari in enumerate(vari_list):
                for i5, model in enumerate(model_list):
                    ...
                    if files:
                        ...
                        # Make directory path
                        save_path = os.path.join(location, exp_dir + '_interp', experi, freq, realm, vari, model)
                        mkdir_p(save_path)
                        # Write nc files
